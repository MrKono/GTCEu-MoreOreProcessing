    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("AAAAAAABBBBB", "G$P$P$GC$$$C", "G$P$P$GC$$$C", "G$P$P$GC$$$C", "G$P$P$GC$$$C", "G$P$P$GC$$$C",
                        ...
                        "########EEE#")
                .aisle("AAAAAAABBBBB", "G$$H$$GC$H$C", "G$$H$$GC$H$C", "G$$H$$GC$H$C", "G$$H$$GC$H$C", "G$$H$$GC$H$C",
                ...
                .where('H', states(MOPMetaBlocks.MOP_GEAR_BOX_CASING.getState(MOPGearBoxCasing.CasingType.IRIDIUM)))
                .where('M', abilities(MultiblockAbility.MUFFLER_HATCH))
                .where('P', states(MOPMetaBlocks.MOP_PIPE_CASING.getState(MOPPipeCasing.CasingType.IRIDIUM)))
