...
public class MOPGlassCasing  extends VariantActiveBlock<MOPGlassCasing.CasingType> {

    public MOPGlassCasing() {
        ...
        setRegistryName("mop_glass_casing");
    ...
    public boolean canRenderInLayer(@NotNull IBlockState state, @NotNull BlockRenderLayer layer) {
        return getState(state) == CasingType.BOROSILICATE_GLASS ? layer == BlockRenderLayer.TRANSLUCENT :
